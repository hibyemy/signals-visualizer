      ...
      <div className="max-w-6xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 pb-12">
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-5 shadow-lg">
          ...
          <p className="text-sm text-gray-200 leading-relaxed font-mono bg-gray-950 p-3 rounded-lg border border-gray-800 mb-4 text-center shadow-inner">
            X[k] = Σ x[n] e⁻ʲ²ᵖⁱᵏⁿ/ᴺ
          </p>
          <p className="text-sm text-gray-400 leading-relaxed">
            The Discrete Fourier Transform (DFT) converts a finite sequence of <span className="font-mono text-gray-300">N</span> time samples into <span className="font-mono text-gray-300">N</span> frequency bins. It calculates the Z-Transform purely on the unit circle.
          </p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-5 shadow-lg">
          <h3 className="text-rose-400 font-semibold mb-3 flex items-center gap-2">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            The workhorse of modern DSP. Used for spectral analysis, MP3/JPEG compression, radar processing, and fast convolutions. Usually computed using the <strong className="text-gray-300">Fast Fourier Transform (FFT)</strong>.
          </p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-5 shadow-lg">
          <h3 className="text-rose-400 font-semibold mb-3 flex items-center gap-2">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Best when you have a block of digital data in a computer and need its frequency content. A common pitfall is <strong className="text-gray-300">spectral leakage</strong>, requiring windowing functions to fix.
          </p>
        </div>
      </div>
    </section>
